    ...
    <div className={styles.container}>
      ...
      <div className={styles.filters}>
        ...
        <div className={styles.filter}>
          ...
          <Select id="fabric">
            <Option value="">Tất cả chất vải</Option>
            <Option value="Vải tổng hợp">Vải tổng hợp</Option>
      ...
      >
        <Form onFinish={handleAddProductSubmit}>
          ...
          <Form.Item label="Chất liệu vải" name="fabric" rules={[{ required: true, message: 'Vui lòng chọn chất liệu vải' }]}>
            <Select>
              <Option value="Vải tổng hợp">Vải tổng hợp</Option>
              <Option value="Da">Da</Option>
            </Select>
          </Form.Item>
          <Form.Item label="Chất liệu đế" name="sole" rules={[{ required: true, message: 'Vui lòng chọn chất liệu đế' }]}>
            <Select>
              <Option value="Cao su">Cao su</Option>
              <Option value="Nhựa">Nhựa</Option>
            </Select>
      ...
      <Modal
        ...
        footer={null}
      >
        <Form initialValues={editingProduct} onFinish={handleEditProductSubmit}>
          <Form.Item label="Tên sản phẩm" name="productName" rules={[{ required: true, message: 'Vui lòng nhập tên sản phẩm' }]}>
            <Input />
          </Form.Item>
          <Form.Item label="Màu" name="color" rules={[{ required: true, message: 'Vui lòng nhập màu sản phẩm' }]}>
