...
import { Input, Select, DatePicker, Slider, Button, Table, Space, Card, message } from 'antd';
...
const CustomerTest = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    <Link to={`/update-customer/${record.id}`}>
                        <Button
                            type="primary"
                            icon={<EditOutlined />}
...
// const { Option } = Select;
// const { RangePicker } = DatePicker;
// const { Password } = Input; // Import Input.Password
...
//                         label="Mật khẩu"
//                         rules={[
//                             { required: !selectedRecord, message: 'Vui lòng nhập mật khẩu!' }, // Required only for create
//                         ]}
//                     >
//                         <Password />
//                     </Form.Item>
