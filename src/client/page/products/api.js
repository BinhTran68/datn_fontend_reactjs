...
export const apigetProductDetail = async (productId, colorId, sizeId,genderId,materialId,soleId) => {
  try {
    const response = await api.get("/getproductdetail", {
      params: { productId: productId, colorId: colorId, sizeId: sizeId,genderId:genderId,materialId:materialId,soleId:soleId },
    });
...
export const apiGetSizesOfProduct = async (productId) => {
  ...
  export const apiGetSizesOfProductAndColor = async (productId,colorId,soleId,materialId,genderId) => {
    try {
      const response = await api.get("/findsizebyproductidandcolorid", {
        params: { productId: productId,colorId: colorId,soleId: soleId,materialId: materialId,genderId: genderId},
      });
      return response.data;
    } catch (error) {
      const errorMessage =
  ...
  export const apiGetColorsOfProductAndSoleId = async (productId,soleId, materialId,genderId) => {
    try {
      const response = await api.get("/find-color-byproductid-and-soleId", {
        params: { productId: productId,soleId: soleId,materialId: materialId,genderId: genderId},
      });
      return response.data;
    } catch (error) {
      const errorMessage =
  ...
  export const apiGetSolesOfProductAndMaterialId = async (productId,materialId,genderId) => {
    try {
      const response = await api.get("/find-sole-byproductid-and-materialId", {
        params: { productId: productId,materialId: materialId,genderId: genderId},
      });
      return response.data;
    } catch (error) {
      const errorMessage =
  ...
  export const apiGetMaterialsOfProductAndGenderId = async (productId,genderId) => {
    try {
